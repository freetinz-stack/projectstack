...
var DEMO_PROFILES = {
  ...
  alex: {
    ...
    monthsData: [
      // ── 5 months ago — mortgage still active ────────────────────────────
      {
        weeks: [
          { items: [
          ...
          { items: [
            ...
            { name: 'Emergency Fund Deposit', amount: 800,  paid: true, dueDay: null },
            { name: 'Kids College — 529',     amount: 1000, paid: true, dueDay: null }
          ]}
        ],
        revenue: [
          { name: 'Salary — Stripe Direct Deposit',    amount: 11800, received: true  },
          { name: 'Consulting — Acme Corp',            amount: 3200,  received: true  },
      ...
      // ── 4 months ago ────────────────────────────────────────────────────
      {
        weeks: [
          ...
          { items: [
            ...
            { name: 'Equipment Loan',         amount: 295,  paid: true, dueDay: 30  },
            { name: 'Emergency Fund Deposit', amount: 800,  paid: true, dueDay: null },
            { name: 'House Renovation Fund',  amount: 600,  paid: true, dueDay: null }
          ]}
        ],
        revenue: [
          { name: 'Salary — Stripe Direct Deposit',    amount: 11800, received: true  },
          ...
          { name: 'Rental Income — Unit 4B',           amount: 1850,  received: true  },
          { name: 'AAPL RSU Vest (5 shares @ $194)',   amount: 970,   received: true  }
        ]
      },
      // ── 3 months ago ────────────────────────────────────────────────────
      {
      ...
      // ── 2 months ago — MORTGAGE FINAL PAYOFF this month ─────────────────
      {
        weeks: [
          { items: [
            { name: 'Mortgage — FINAL PAYOFF',amount: 12840, paid: true, dueDay: 1, note: '🎉 Final balloon payment — mortgage fully paid off!' },
            { name: 'Student Loan',           amount: 310,  paid: true, dueDay: 2  },
            { name: 'Tesla Model 3 Loan',     amount: 780,  paid: true, dueDay: 5  },
            { name: 'HELOC Payment',          amount: 420,  paid: true, dueDay: 6  },
            { name: 'Bank Service Charge',    amount: 18,   paid: true, dueDay: 3  }
          ...
          { items: [
            ...
            { name: 'House Renovation Fund',  amount: 600,  paid: true, dueDay: null },
            { name: 'Kids College — 529',     amount: 1000, paid: true, dueDay: null },
            { name: 'Next Vehicle Fund',      amount: 500,  paid: true, dueDay: null }
          ]}
        ],
        revenue: [
          { name: 'Salary — Stripe Direct Deposit',    amount: 11800, received: true  },
          { name: 'Consulting — Acme Corp',            amount: 3800,  received: true  },
          { name: 'Rental Income — Unit 4B',           amount: 1850,  received: true  },
          { name: 'AAPL RSU Vest (5 shares @ $196)',   amount: 980,   received: true  },
          { name: 'Dividend — VOO/QQQ',                amount: 392,   received: true  }
        ]
      },
      // ── 1 month ago — first full month mortgage-free ────────────────────
      {
        weeks: [
          { items: [
            { name: 'Student Loan',           amount: 310,  paid: true, dueDay: 2  },
      ...
      // ── Current month — mortgage-free, pending items ──────────────────
      {
        weeks: [
          { items: [
            { name: 'Student Loan',           amount: 310,  paid: true,  dueDay: 2  },
          ...
          { items: [
            ...
            { name: 'Emergency Fund Deposit', amount: 800,  paid: true,  dueDay: null },
            { name: 'House Renovation Fund',  amount: 600,  paid: false, dueDay: null },
            { name: 'Kids College — 529',     amount: 1000, paid: false, dueDay: null },
            { name: 'Next Vehicle Fund',      amount: 500,  paid: false, dueDay: null }
          ]}
        ],
        revenue: [
          ...
          { name: 'AAPL RSU Vest (5 shares @ $198)',   amount: 990,   received: false, note: 'Scheduled vest date: 15th'       },
    ...
    budgets: {
      Banking: 80, Telecom: 200, Subscriptions: 150, Auto: 900,
      Utilities: 300, Housing: 4200, 'Food/Meals': 1200,
      Entertainment: 400, Fees: 50, Health: 600,
      'Loan Pmt': 2400, Tuition: 300, Savings: 1800, Other: 600
    },
    loans: [
      { name: 'Mortgage — Primary Residence', amount: 387500, originalAmount: 520000, rate: 3.875, minPayment: 2440 },
      { name: 'Tesla Model 3 Loan',           amount: 22800,  originalAmount: 48000,  rate: 4.99,  minPayment: 780  },
      { name: 'Student Loan — Federal',       amount: 14200,  originalAmount: 38000,  rate: 5.05,  minPayment: 310  },
      { name: 'Home Equity Line (HELOC)',     amount: 31000,  originalAmount: 50000,  rate: 7.25,  minPayment: 420  },
      { name: 'Business Equipment Loan',      amount: 8400,   originalAmount: 15000,  rate: 6.5,   minPayment: 295  }
    ],
    savings: [
      { name: 'Emergency Fund (6 months)',    target: 55000,  balance: 48200, contribution: 1000, rate: 4.85 },
      { name: 'House Renovation Fund',        target: 30000,  balance: 18700, contribution: 500,  rate: 4.20 },
      { name: 'Kids College — 529',           target: 120000, balance: 34800, contribution: 800,  rate: 6.10 },
      { name: 'Next Vehicle Fund',            target: 25000,  balance: 9400,  contribution: 400,  rate: 3.90 }
    ],
    investments: [
      { name: 'S&P 500 ETF',          type: 'stock',   amount: 112000, symbol: 'VOO',   shares: 248, purchasePrice: 380, currentPrice: 492, notes: 'Core DCA — monthly auto-invest' },
      { name: 'Tech Growth ETF',      type: 'etf',     amount: 58400,  symbol: 'QQQ',   shares: 130, purchasePrice: 380, currentPrice: 490, notes: 'Growth sleeve — 20% of portfolio' },
      { name: 'International ETF',    type: 'etf',     amount: 24200,  symbol: 'VXUS',  shares: 410, purchasePrice: 55,  currentPrice: 63,  notes: 'Global diversification' },
      { name: 'Bond Ladder',          type: 'etf',     amount: 31500,  symbol: 'BND',   notes: 'Capital preservation — 5yr horizon' },
      { name: 'Bitcoin',              type: 'crypto',  amount: 42000,  symbol: 'BTC',   notes: '0.68 BTC — long-term hold, cold wallet' },
      { name: 'Ethereum',             type: 'crypto',  amount: 11800,  symbol: 'ETH',   notes: '5.2 ETH — DeFi exposure' },
      { name: 'Rental Property — Unit 4B', type: 'real_estate', amount: 185000, notes: 'Cash-flowing duplex — acquired 2021' },
      { name: 'Private Equity — Seed Fund', type: 'other',      amount: 15000,  notes: 'AngelList deal — 10yr lock-up' },
      { name: 'High-Yield Savings (HYSA)', type: 'other',       amount: 22000,  notes: 'Ally Bank — operational reserve' },
      { name: 'Apple Stock (AAPL)',    type: 'stock',   amount: 38600,  symbol: 'AAPL',  shares: 210, purchasePrice: 142, currentPrice: 198, notes: 'RSU vested shares — holding' }
    ],
    scheduledExpenses: [],
    xp: 8450,
    xpLevel: 5,
